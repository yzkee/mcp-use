...
export const HeroCard = ({ filename, title, description, href }) => {
  return (
    <a className="group cursor-pointer pb-8" href={href}>
      <img src={`/images/${filename}-light.png`} className="block dark:hidden pointer-events-none group-hover:scale-105 transition-all duration-100" />
...
<HeroCard filename="quickstart" title="Quick Start" description="Get up and running in minutes with our step-by-step guide" href="/quickstart" />

<HeroCard filename="installation" title="Installation" description="Install mcp_use and set up your development environment" href="/installation" />

<HeroCard filename="configuration" title="Configuration" description="Learn how to configure MCP servers and LLM providers" href="/essentials/configuration" />

<HeroCard filename="examples" title="Examples" description="Explore real-world examples and advanced use cases" href="https://github.com/mcp-use/mcp-use/tree/main/examples" />
